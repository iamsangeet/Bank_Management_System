...
<body class="bank_management">
    ...
    <div id="wrapper">
       ...
       <div id="sidebar-wrapper">
        ...
        <!-- Page Content -->
  <button type="button" class="block" onclick="window.location.href='register_customer.php';">Add Customer</button>
  <table>
  <tr>
  ...
  <tr>
    ...
    <td><a type="button" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn" href="edit_customer.php?account_no=<?php echo $value['ACCOUNT_NO'];?>">Edit</a></td>
    <td><a type="button" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn" href="delete_customer.php?account_no=<?php echo $value['ACCOUNT_NO'];?>" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a></td>
 </tr>
  <?php } //loop ends 
  ?>
</table>
