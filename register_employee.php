...
<body class="bank_management">
    ...
    <div id="wrapper">
        ...
        <div class="container">
    <form class="well form-horizontal" method="post" action="process_register_employee.php" enctype="multipart/form-data">
    <fieldset>
        <legend><h3>
       ...
       <div class="form-group">
        <label class="col-md-4 control-label">Picture</label>
            ...
            <div class="input-group">
                ...
                <input type="file" name="employee_pic" id="employee_pic" class= "form-control">
                </div>
            </div>
        </div>
        <div class="form-group">
