...
$sql = "SELECT * FROM Customers WHERE account_no = :account_no ";
...
<body class="bank_management">
    ...
    <div id="wrapper">
        ...
        <div class="container">
    <form class="well form-horizontal" method="post" action="process_edit_customer.php" enctype="multipart/form-data">
    <fieldset>
        <legend><h3>
       ...
       <div class="form-group">
        <label class="col-md-4 control-label">Account Number</label>
            ...
            <div class="input-group">
                ...
                <input type="number" name="account_no" class= "form-control" value="<?php echo $data['ACCOUNT_NO'];?>" readonly>
                </div>
            </div>
        </div> 
        <div class="form-group">
        ...
        <label class="col-md-4 control-label">Account Name</label>
            ...
            <div class="input-group">
                ...
                <input type="text" name="account_name" class= "form-control" value="<?php echo $data['ACCOUNT_NAME'];?>" required>
                </div>
            </div>
        </div>
         <div class="form-group">
        <label class="col-md-4 control-label">Balance</label>
            ...
            <div class="input-group">
                ...
                <input type="number" name="balance" class= "form-control" value="<?php echo $data['BALANCE'];?>" required>
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <input type="hidden" name="old_account_no" value="<?php echo $data['ACCOUNT_NO']; ?>" />
