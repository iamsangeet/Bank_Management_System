...
<body class="bank_management">
  ...
  <button type="button" class="block" onclick="window.location.href='register_employee.php';">Add Employee</button>
			 <?php    foreach ($data as $key=>$value){ ?>
			 	<br><img src="<?php echo $value['EMPLOYEE_PIC'];?>" alt="<?php echo $value['EMPLOYEE_ID']; ?>" title="<?php echo $value['EMPLOYEE_ID']; ?>" height="300px" width="350"/>
            <li class="design"><b>Branch ID: <?php echo $value['BRANCH_ID']; ?><b></li>
            <li class="design"><b>Employee ID: <?php echo $value['EMPLOYEE_ID']; ?><b></li>
            <li class="design"><b>Name: <?php echo $value['EMPLOYEE_NAME']; ?><b></li>
            <li class="design"><b>Salary: <?php echo $value['SALARY'];?><b></li>
            <li class="design"><b>Address: <?php echo $value['ADDRESS'];?><b></li>
            <li class="design"><b>Phone: <?php echo $value['PHONE']; ?><b></li>
